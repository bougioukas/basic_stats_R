...
-   Compare two independent samples applying paired t-test
...
**Visualization of the distribution of differences**

We can explore the data visually for symmetry with a density plot (a smoothed version of the histogram):
...
Summary statistics can also be inspected for the variables.
