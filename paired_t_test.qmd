...
There was a significant reduction in weight (mean change = 39.6 g, sd = 32.3[^paired_t_test-1]) after the discharge (p-value \<0.001 that is lower than 0.05; reject $H_0$). Note that the 95% confidence interval (26.3 to 52.9) doesn't include the null hypothesized value of zero. However, is this reduction of clinical importance?
