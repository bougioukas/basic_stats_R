...
-   Compare two independent samples (Student's t-test)
...
**Note:** A score of 0--7 in [:HDRS](https://en.wikipedia.org/wiki/Hamilton_Rating_Scale_for_Depression) is generally accepted to be within the normal range, while a score of 20 or higher indicates at least moderate severity.
