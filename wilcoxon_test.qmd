...
```{r, fig.width=4.5, fig.height=3.0, fig.align="center"}
eyes %>%
...
**Normality test**
We can use Shapiro-Wilk test to check for normality of the differences. However, here, normality test is not helpful because of the small sample (the test is under-powered).
