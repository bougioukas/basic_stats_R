...
There is not evidence from this small study with patients of glaucoma that the thickness of the cornea in affected eyes, median = 459 $\mu{m}$ (IQR: 436.5, 478.5), differs from unaffected eyes 470 $\mu{m}$ (442, 479.5) (p=0.30 \>0.05).
