...
arrhythmia %>% 
  ...
  annotate('text', x = 54, y = 105, label = 'mean', size = 5, color = '#009e73') +
  annotate('text', x = 41, y = 105, label = 'median', size = 5, color = 'grey30')
...
arrhythmia %>% 
  ...
  theme_minimal() +
    labs(y = "Frequency") +
  theme(text = element_text(size = 16)) +
  annotate('text', x = 96, y = 140, label = 'mean', size = 5, color = '#009e73') +
  annotate('text', x = 78, y = 140, label = 'median', size = 5, color = 'grey30')
```
...
arrhythmia %>% 
  ...
  labs(y = "Density") +
  theme(text = element_text(size = 16)) +
  annotate('text', x = 54, y = 0.026, label = 'mean', size = 5, color = '#009e73') +
  annotate('text', x = 41, y = 0.026, label = 'median', size = 5, color = 'grey30')
...
arrhythmia %>% 
  ...
  labs(y = "Density") +
  theme(text = element_text(size = 16)) +
  annotate('text', x = 96, y = 0.038, label = 'mean', size = 5, color = '#009e73') +
  annotate('text', x = 78, y = 0.038, label = 'median', size = 5, color = 'grey30')
```
...
#| warning: false
#| label: fig-raincloud
#| fig-cap: A raincloud plot of age and QRS variables by sex.
#| fig-subcap: 
#|   - "Raincloud of age for the 428 patients by sex."
#|   - "Raincloud of QRS for the 428 patients by sex."
#| layout-ncol: 2

# raincloud plot of age by sex
arrhythmia %>% 
  ggplot(aes(x = sex, y = age, fill = sex)) +
  ...
  stat_dotsinterval(side = "bottom", 
                    scale = 0.5, 
                    slab_size = 0.2) +
  ggtitle("Grouped Raincloud Plots age") +
  theme_minimal() +
  ggsci::scale_fill_jco() +
  theme(text = element_text(size = 16),
        legend.position = "none")

# raincloud plot of QRS by sex
arrhythmia %>% 
  ggplot(aes(x = sex, y = QRS, fill = sex)) +
  stat_slab(aes(thickness = stat(pdf*n)), 
                scale = 0.5) +
  stat_dotsinterval(side = "bottom", 
                    scale = 0.5, 
                    slab_size = 0.2) +
  ggtitle("Grouped Raincloud Plots QRS") +
  theme_minimal() +
  ggsci::scale_fill_jco() +
  theme(text = element_text(size = 16),
        legend.position = "none")
