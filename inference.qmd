...
|------------------------|------------------------------------------------|
| **Effect Size**          | As effect size increases, power tends to increase.   |
| **Sample Size**          | As the sample size goes up, power generally goes up. |
| **Standard deviation**   | As variability decreases, power tends to increase.   |
| **Significance level α** | As α goes up, power goes up.                         |
