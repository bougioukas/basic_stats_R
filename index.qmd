...
#| out-width: "40%"
#| echo: false
#| fig-cap: Visualizing the folder structure of a standard RStudio project.
#| 
knitr::include_graphics(here::here("images", "project.png"))
```
