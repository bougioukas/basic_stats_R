...
#| out-width: "40%"
#| echo: false
#| fig-cap: Visualizing the folder structure of a minimal RStudio project.
#| fig-subcap: The folder structure of a minimal RStudio project.
...
![](images/quarto.png){width="24" height="22"} [Quarto](https://quarto.org/)^®^ which is an open-source scientific and technical publishing system built on [Pandoc](https://pandoc.org/).
